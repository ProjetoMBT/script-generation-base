...
{
    public class UmlToGraph : ModelingStructureConverter
    {
        #region Attributes
        ...
        public DirectedGraph ActivityDiagramToGraph(UmlActivityDiagram diagram, UmlModel model)
        {
            ...
            while (haveHyperlinks)
            {
                ...
                haveHyperlinks = transitions.Where(x => x.Source.TaggedValues.ContainsKey("jude.hyperlink")
                                                     || x.Target.TaggedValues.ContainsKey("jude.hyperlink")).Count() > 0;
            }
            ...
            foreach (UmlTransition t in transitions)
            {
                ...
                input = t.GetTaggedValue(inputTag);
                ...
                if (input != null)
                {
                    ...
                    output = "";
                    if (t.GetTaggedValue(outputTag) != null)
                    {
                        output = t.GetTaggedValue(outputTag);
                    }
                    ...
                    tags.Add(inputTag, input);
                    tags.Add(outputTag, output);
